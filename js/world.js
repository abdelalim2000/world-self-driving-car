class World {
  ...
  #generateBuildings() {
    ...
    const guides = Polygon.union(tmpEnvelops.map((tmp) => tmp.poly));
  ...
  #generateTrees() {
    ...
    while (tryCount < 100) {
      ...
      // check if trees is inside or nearby buildings / roads
      let keep = true;
      ...
      // check if trees too close to other trees
      if (keep) {
